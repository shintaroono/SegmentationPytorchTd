...
def parse_args():
    ...
    parser.add_argument('--spout_size', nargs = 2, type=int, default=[128, 128], help='Width and height of the spout receiver and sender')   
...
def main_pipeline(data):
    ...
    # test to load and print their info. #
    # image = face_recognition.api.load_image_file("ayu.jpg")
    # print(image)
    # print(data.shape)
    # print(image.shape)
    ...
    # face_locations = face_recognition.face_locations(data, model="cnn")
    ...
    # share texture with td syphon out. #
